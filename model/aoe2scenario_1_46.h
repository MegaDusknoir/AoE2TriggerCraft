...
namespace AoE2Scenario_1_46_Namespace
{
    using namespace AoE2ScenarioFileTypesNamespace;
    class AoE2Scenario_1_46
    {
    public:
        class FileHeader
        {
        ...
        public:
            ...
            struct TriggersStruct
            {
                ...
                struct TriggerStruct
                {
                    ...
                    struct ConditionStruct
                    {
                        ...
                        int32_t object_state;       //单位状态
                        int32_t unknown_new1_in_1_46;       //新未知量
                        int32_t unknown_new2_in_1_46;       //新未知量
                        int32_t new_in_1_46;       //包括可更换的武器物体
                        ...
                        void read(const char*& p_bin)
                        {
                            ...
                            data_read(unknown_4, p_bin);
                            data_read(object_state, p_bin);
                            data_read(unknown_new1_in_1_46, p_bin);
                            data_read(unknown_new2_in_1_46, p_bin);
                            data_read(new_in_1_46, p_bin);
                        ...
                        void write(char*& p_bin) const
                        {
                            ...
                            data_write(unknown_4, p_bin);
                            data_write(object_state, p_bin);
                            data_write(unknown_new1_in_1_46, p_bin);
                            data_write(unknown_new2_in_1_46, p_bin);
                            data_write(new_in_1_46, p_bin);
            ...
            struct FilesStruct
            {
                ...
                {
                    data_read(unknown_2, p_bin);
                    data_read(unknown_new_in_1_46, p_bin);
                ...
                {
                    data_write(unknown_2, p_bin);
                    data_write(unknown_new_in_1_46, p_bin);
